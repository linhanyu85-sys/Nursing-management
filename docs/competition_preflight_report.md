...
Generated at: 2026-03-25 17:22:58 +08:00

Target stack: api=8000, device=8013, patient_context=28002
...
| workflow_recommendation | PASS | status=completed; bed=12; patient=ec328696-59c5-4ba5-9714-281152afa0ed; stt_len=68; summary_len=166; review_required=True |
| db_persist_document_drafts | PASS | before=15, after=16, delta=1 |
| db_persist_handover_records | PASS | before=10, after=11, delta=1 |
| db_persist_ai_recommendations | PASS | before=18, after=19, delta=1 |
| db_persist_audit_logs | PASS | before=46, after=53, delta=7 |

## DB Counters

| Table | Before | After | Delta |
|---|---:|---:|---:|
| document_drafts | 15 | 16 | 1 |
| handover_records | 10 | 11 | 1 |
| ai_recommendations | 18 | 19 | 1 |
| audit_logs | 46 | 53 | 7 |
