...
def version() -> dict:
    return {
        ...
        "include_virtual_empty_beds": settings.include_virtual_empty_beds,
        "virtual_bed_no_start": settings.virtual_bed_no_start,
        "virtual_bed_no_end": settings.virtual_bed_no_end,
    }
